    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-soft px-4">
          ...
          <a 
            ...
            className="flex items-center justify-center gap-2 w-full btn-theme text-white px-6 py-3 rounded-xl font-semibold transition-all duration-200 mb-3 shadow-[0_4px_12px_rgba(37,211,102,0.18)] hover:-translate-y-0.5"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="card p-6">
            ...
            <button
              ...
              className="w-full btn-theme py-3 rounded-xl font-semibold"
            >
              Solicitar acceso
            </button>
          </div>
