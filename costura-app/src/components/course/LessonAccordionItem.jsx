...
export default function LessonAccordionItem({
  ...
  return (
    <div id={`lesson-${lesson.id}`} className={`bg-white border rounded-2xl shadow-sm overflow-hidden transition-colors ${isOpen ? 'border-secondary bg-secondary/10' : 'border-border'}`}>
