...
export default function BackToHome() {
  ...
  return (
    <Link to={target} style={{ zIndex: 9999 }} className="fixed top-4 left-4">
      <div className="w-9 h-9 bg-white/90 text-primary rounded-full shadow-md flex items-center justify-center border border-border hover:bg-white transition-colors">
